...
const UserPage = ({ route, navigation }) => {
  const { username } = route.params; // Get username from the previous screen
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonGrid}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('EnterDataPage')} // Navigate to Enter Data Page
        >
        ...
        <TouchableOpacity
          style={styles.optionButton}
          onPress={() => navigation.navigate('FindNutritionistPage')} // Navigate to Find Nutritionist Page
        >
